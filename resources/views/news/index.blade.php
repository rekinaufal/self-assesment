                    ...
                    <div class="card-body pb-0">
                        <div class="">
                            ...
                            <div class="content d-flex flex-column flex-md-row pt-3">
                                ...
                                <div class="button-group d-flex h-auto">
                                    ...
                                    <a href="#" class="btn btn-primary btn-sm px-lg-3 py-lg-2 mb-1 text-nowrap"
                                        style="height: min-content" data-toggle="modal" data-target="#createNewsModal">
                                        Add New<i class="fas fa-plus ml-3"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="news" class="row px-4 pt-3">
                        @foreach ($news as $newsItem)
                            <div class="col-12 col-md-6 col-xl-4">
                                <div class="card">
                                    <div class="card-header d-flex h-auto w-100 justify-content-between">
                        ...
                        <ul class="pagination justify-content-center">
                            ...
                            @else
                                <li class="page-item"><a class="page-link"
                                        href="{{ $news->previousPageUrl() }}">Previous</a></li>
                            @endif
                            ...
                            @if ($news->hasMorePages())
                                <li class="page-item"><a class="page-link" href="{{ $news->nextPageUrl() }}">Next</a>
                                </li>
                            @else
