            ...
            <div class="col-4">
                ...
                <div class="card">
                    <div class="nav flex-column nav-pills position-relative" id="v-pills-tab" role="tablist"
                        ...
                        <a class="nav-link text-dark" id="v-pengembangan" data-toggle="pill"
                            href="#v-pengembangan" role="tab" aria-controls="v-pengembangan"
                            aria-selected="false">
                            <button class="btn-primary">2.0</button>
                            Pengembangan
                        </a>
                        <a class="nav-link text-dark" id="v-rekapitulasi-tkdn-tab" data-toggle="pill"
                            href="#v-rekapitulasi-tkdn" role="tab" aria-controls="v-rekapitulasi-tkdn"
                            aria-selected="false">
                            <button class="btn-primary">2.1</button>
                            Rekapitulasi TKDN
                        </a>
                    </div>
                </div>
    ...
    <script>
        ...
        $(() => {
            ...
            $(".nav-link").on("click", (event) => {
                ...
                if($(event.currentTarget).attr("id") == "v-rekapitulasi-tkdn-tab") {
