                ...
                <div class="w-100 h-100 row no-gutters">
                    <div class="left-content col-12 col-lg-6 d-none d-lg-block">
                        <div class="closer w-100 h-100 position-relative"
                            style="background: rgb(181,0,0); background: linear-gradient(45deg, rgba(181,0,0,1) 0%, rgba(121,9,9,1) 31%, rgba(0,0,0,1) 100%); transition-duration: 400ms; z-index: 5">
                    ...
                    <div class="right-content col-12 col-lg-6 p-3 p-md-5 w-100 h-100 d-flex justify-content-center align-items-center">
                        <div id="authContent" class="content d-flex justify-content-center align-items-center w-100"
                            ...
                            <div class="regist-form w-100" style="min-width: 100%; transform: translateX(-25%); opacity: 0; transition-duration: 400ms">
                            ...
                            <div class="login-form w-100" style="min-width: 100%; opacity: 1; transition-duration: 400ms">
                                <div class="welcome-text d-flex justify-content-center">
                                    @if ($errors->any())
                                        <div class="alert alert-danger alert-dismissible show fade">
                                            <div class="alert-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#signupButton").on("click", () => {
                $(".closer").css('transform', 'translateX(100%)')
                setTimeout(() => {
                    $(".regist-form").css("opacity", "1");
                    $(".login-form").css("opacity", "0");
                }, 100);
            })
            $("#signinButton").on("click", () => {
                $(".closer").css('transform', 'translateX(0)')
                setTimeout(() => {
                    $(".regist-form").css("opacity", "0");
